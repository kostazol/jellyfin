...
public class ItemPersistenceServiceSaveImagesTests : SqliteDbTestFixture
{
    ...
    {
        _service = new ItemPersistenceService(CreateDbContextFactory(), Mock.Of<IServerApplicationHost>(), Mock.Of<IServerConfigurationManager>(), NullLogger<ItemPersistenceService>.Instance);
    }
